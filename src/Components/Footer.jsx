...
const Footer = () => {
    return (
        <>
            <aside className="footerAside pt-9 pb-sm-2 pt-xl-14 pb-xl-12 mt-5" style={{ backgroundColor: '#06163a' }}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <p className='text-white text-justify'>
                                Blessed Virgin Mary a multicultural, international Institute founded by an English woman, Mary Ward.  We are known informally as Loreto Sisters. The IBVM comprised of three branches:
                            </p>
                            <a
                            ...
                            >
                                <span className="d-block btnText text-white">Read More</span>
                            </a>
                        </div>
                        <div className="col-lg-2 col-md-6 col-sm-12">
                            <div className="pl-xlwd-11">
                                <div className='section-headings'>
                                    <h3 className="ftHeading text-white mb-4">Useful Links</h3>
                                </div>
                            ...
                            <div className="pl-xlwd-11">
                                ...
                                <ul className="list-unstyled ftsrLinksList mb-0">
                                    <iframe
                                        ...
                                        style={{ border: 0, height: '180px',width:"250px" }}
                                        allowFullScreen=""
                                        loading="lazy"
                                        title='loreto'
